...
<head>
    ...
    <title>Selector de Partes del Cuerpo Personalizado</title>
...
<body>
    <div id="app">
        <div class="selector-container">
            <h1>Selector de Partes del Cuerpo</h1>
            <svg viewBox="0 0 200 400" width="75rem" height="150rem">
                <path @click="selectPart('head')" :class="['body-part', {'selected': parteSeleccionada === 'head'}]"
                    ...
                    id="head" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('face')" :class="['body-part', {'selected': parteSeleccionada === 'face'}]"
                    ...
                    id="face" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('neck')" :class="['body-part', {'selected': parteSeleccionada === 'neck'}]"
                    ...
                    id="neck" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('shoulder-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'shoulder-left'}]"
                    ...
                    id="shoulder-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('shoulder-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'shoulder-right'}]"
                    ...
                    id="shoulder-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('arm-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'arm-left'}]"
                    ...
                    id="arm-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('forearm-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'forearm-left'}]"
                    ...
                    id="forearm-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('arm-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'arm-right'}]"
                    ...
                    id="arm-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('forearm-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'forearm-right'}]"
                    ...
                    id="forearm-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('chest-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'chest-left'}]"
                    ...
                    id="chest-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('chest-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'chest-right'}]"
                    ...
                    id="chest-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('belly-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'belly-left'}]"
                    ...
                    id="belly-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('ribs-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'ribs-left'}]"
                    ...
                    id="ribs-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('belly-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'belly-right'}]"
                    ...
                    id="belly-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('belly')" :class="['body-part', {'selected': parteSeleccionada === 'belly'}]"
                    ...
                    id="belly" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('ribs-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'ribs-right'}]"
                    ...
                    id="ribs-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('thigh-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'thigh-left'}]"
                    ...
                    id="thigh-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('innerthigh-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'innerthigh-left'}]"
                    ...
                    id="innerthigh-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('feet-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'feet-left'}]"
                    ...
                    id="feet-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('calf-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'calf-left'}]"
                    ...
                    id="calf-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('knee-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'knee-left'}]"
                    ...
                    id="knee-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('thigh-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'thigh-right'}]"
                    ...
                    id="thigh-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('genitalia')"
                    :class="['body-part', {'selected': parteSeleccionada === 'genitalia'}]"
                    ...
                    id="genitalia" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('innerthigh-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'innerthigh-right'}]"
                    ...
                    id="innerthigh-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('right-feet')"
                    :class="['body-part', {'selected': parteSeleccionada === 'right-feet'}]"
                    ...
                    id="right-feet" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('calf-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'calf-right'}]"
                    ...
                    id="calf-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('knee-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'knee-right'}]"
                    ...
                    id="knee-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('elbow-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'elbow-right'}]"
                    d="m 3.2054751,27.370125 0.005,3.09419 -0.57959,1.91184 -0.54539,-2.41185 z" id="elbow-right"
                    style="fill: #cccccc;">
                </path>
                <path @click="selectPart('hand-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'hand-right'}]"
                    ...
                    id="hand-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('elbow-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'elbow-left'}]"
                    d="m 28.325215,27.370125 -0.005,3.09419 0.57959,1.91184 0.54538,-2.41185 z" id="elbow-left"
                    style="fill: #cccccc;">
                </path>
                <path @click="selectPart('hands-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'hands-left'}]"
                    ...
                    id="hands-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('armback-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'armback-left'}]"
                    ...
                    id="armback-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('leg-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'leg-left'}]"
                    ...
                    id="leg-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('buttock')"
                    :class="['body-part', {'selected': parteSeleccionada === 'buttock'}]"
                    ...
                    id="buttock" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('loin')" :class="['body-part', {'selected': parteSeleccionada === 'loin'}]"
                    ...
                    id="loin" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('column')" :class="['body-part', {'selected': parteSeleccionada === 'column'}]"
                    d="m 51.733705,14.788555 0.53876,25.33066 0.48967,-0.0297 0.65658,-25.3387 -0.28147,-0.84188 -1.25059,-4.9e-4 z"
                    id="column" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('head-back')"
                    :class="['body-part', {'selected': parteSeleccionada === 'head-back'}]"
                    ...
                    id="head-back" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('nape')" :class="['body-part', {'selected': parteSeleccionada === 'nape'}]"
                    ...
                    id="nape" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('armback-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'armback-right'}]"
                    ...
                    id="armback-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('leg-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'leg-right'}]"
                    ...
                    id="leg-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('back-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'back-right'}]"
                    ...
                    id="back-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('clavicule-right')"
                    :class="['body-part', {'selected': parteSeleccionada === 'clavicule-right'}]"
                    d="m 55.439085,14.728535 -0.063,-2.62463 0.71441,1.15181 4.37994,1.49796 -4.97857,8.36746 -1.83043,5.08189 0.21949,-13.55362 z"
                    id="clavicule-right" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('back-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'back-left'}]"
                    ...
                    id="back-left" style="fill: #cccccc;">
                </path>
                <path @click="selectPart('clavicule-left')"
                    :class="['body-part', {'selected': parteSeleccionada === 'clavicule-left'}]"
                    d="m 49.625175,14.629325 0.063,-2.62462 -0.71441,1.15181 -4.37994,1.49796 4.97857,8.36746 1.83043,5.08188 -0.21949,-13.55362 z"
                    id="clavicule-left" style="fill: #cccccc;">
                </path>
                <!-- Añade aquí el resto de las partes del cuerpo -->
            </svg>
        </div>
