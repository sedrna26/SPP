...
// Modificar la tabla para incluir idppl y categoria
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && $_POST['action'] === 'delete') {
        ...
        $sql = "DELETE FROM marcas_cuerpo WHERE id = '$id' AND idppl = '$idppl'";
        ...
        $sql = "INSERT INTO marcas_cuerpo (idppl, x, y, description, categoria) 
                VALUES ('$idppl', '$x', '$y', '$description', '$categoria')";
...
if (isset($_GET['action']) && $_GET['action'] === 'get_marks') {
    $sql = "SELECT id, x, y, description, categoria FROM marcas_cuerpo WHERE idppl = '$idppl' ORDER BY id";
