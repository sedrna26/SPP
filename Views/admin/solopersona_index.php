            ...
            <div class="col-sm">
                <div class="card rounded-2 border-0">
                    <div class="card-header bg-dark text-white pb-0">
                        <center>
                            <h1 class="d-inline-block">Listado PERSONA</h1>
                        </center>
                        <ul>
                            <a class="btn btn-primary float-right mb-2" href="persona_crea.php">Agregar PERSONA</a>
                        </ul>
                    </div>
                    <div class="card-body table-responsive">
                        <table id="example" class="table table-striped table-sm" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                try {
                                    $query = "SELECT p.id, p.dni, p.nombres, p.apellidos, p.foto, p.fechanac, p.edad, p.genero, p.estadocivil
                                          FROM persona AS p
                                          ORDER BY p.id ASC";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($row['fechanac'], ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlspecialchars($row['edad'], ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlspecialchars($row['genero'], ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlspecialchars($row['estadocivil'], ENT_QUOTES, 'UTF-8'); ?></td>
