                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <p><?php 
// Depuración: Imprimir todos los valores de dirección
echo "<pre>";
print_r($persona);
echo "</pre>";

$direccionCompleta = [];
if (!empty($persona['pais'])) $direccionCompleta[] = $persona['pais'];
if (!empty($persona['provincia'])) $direccionCompleta[] = $persona['provincia'];
if (!empty($persona['ciudad'])) $direccionCompleta[] = $persona['ciudad'];
if (!empty($persona['localidad'])) $direccionCompleta[] = $persona['localidad'];
if (!empty($persona['direccion'])) $direccionCompleta[] = $persona['direccion'];

echo !empty($direccionCompleta) 
    ? htmlspecialchars(implode(', ', $direccionCompleta), ENT_QUOTES, 'UTF-8') 
    : 'No hay dato'; 
?></p>
                        </div>
                    </div>
